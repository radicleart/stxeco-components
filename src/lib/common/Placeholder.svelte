<script lang="ts">
	import NakamotoBackground from "../assets/NakamotoBackground.svelte";
	import NakamotoShield from "../assets/NakamotoShield.svelte";

	export let message:string|undefined;
	export let link:{name:string, address:string};
</script>
